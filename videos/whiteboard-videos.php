...
<section class="jumbotron-fluid bg-image">
	<h1 class="banner-text">Stunning Whiteboard, Whiteboard Explainer, Whiteboard Drawing and Custom Videos</h1>
	<?php include("../includes/jumbo.php"); ?>
</section>
<section class="content">
	<h2 class="banner-bottom-text">Whiteboard Videos, Whiteboard Animation Videos, Whiteboard Video Production, Custom Whiteboard Videos, Sketch and Doodle Videos.</h2>
</section>
