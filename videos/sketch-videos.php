...
<section class="jumbotron-fluid bg-image">
	<h1 class="banner-text">Stunning Sketch Videos, Sketch Animation Videos, Hand Sketch Videos!</h1>
	<?php include("../includes/jumbo.php"); ?>
</section>
<section class="content">
	<h2 class="banner-bottom-text">Hand Sketch Videos, Whiteboard Sketch Animation Videos, Whiteboard Sketch, Video Scribe and Doodle Videos.</h2>
</section>
