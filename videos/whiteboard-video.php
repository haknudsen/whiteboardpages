...
<section class="jumbotron-fluid bg-image">
	<h1 class="banner-text">Awesome Whiteboard Animation Videos, Video Sketch Animation, Animated Whiteboard!</h1>
	<?php include("../includes/jumbo.php"); ?>
</section>
<section class="content">
	<h2 class="banner-bottom-text">Whiteboard Animation Videos, Animated Whiteboard Videos, Sketch animations, Sketch and Doodle Animation Videos.</h2>
</section>
