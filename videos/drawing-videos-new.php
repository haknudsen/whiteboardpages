...
<section class="jumbotron-fluid bg-image">
	<h1 class="banner-text">Persuasive and Custom Drawing Videos, Drawing Explainer Video, Animated Drawing Videos</h1>
	<?php include("../includes/jumbo.php"); ?>
</section>
<section class="content">
	<h2 class="banner-bottom-text">Hand Drawn Videos, Drawing Animation Videos, Whiteboard Video Production, Custom Drawing Videos, Sketch and Doodle Videos.</h2>
</section>
